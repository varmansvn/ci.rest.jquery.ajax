...
class Doctrine
{
    ...
    public function __construct()
    {
        ...
        //$entityClassLoader = new \Doctrine\Common\ClassLoader('models', APPPATH);
        ...
        $entityClassLoader = new \Doctrine\Common\ClassLoader('Repositories', APPPATH.'models/Entities');
        $entityClassLoader->register();
